...
- `platform` (optional) a list of string arguments which defines which platforms buildx should target; defaults to empty
- `cacheFrom` (optional) a list of string arguments which define source [cache storage backends](https://docs.docker.com/build/cache/backends/) for buildx; defaults to empty
- `cacheTo` (optional) a list of string arguments which define target [cache storage backends](https://docs.docker.com/build/cache/backends/) for buildx; defaults to empty
